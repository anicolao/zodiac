...
![The private six-photo ritual starts with the approved celestial art direction](./screenshots/000-welcome-phone.png)
...
![CASTLE is read from its printed card and its sized tokens are found](./screenshots/001-recognized-castle-phone.png)
...
![DRAGON is read from its printed card and its sized tokens are found](./screenshots/002-recognized-dragon-phone.png)
...
![SAILBOAT is read from its printed card and its sized tokens are found](./screenshots/003-recognized-sailboat-phone.png)
...
![ELEPHANT is read from its printed card and its sized tokens are found](./screenshots/004-recognized-elephant-phone.png)
...
![GUITAR is read from its printed card and its sized tokens are found](./screenshots/005-recognized-guitar-phone.png)
...
![HOT AIR BALLOON is read from its printed card and its sized tokens are found](./screenshots/006-recognized-hot-air-balloon-phone.png)
...
![The complete game is reviewed before generation](./screenshots/007-six-card-review-phone.png)
...
![The approved square Zodiac is completed entirely on device](./screenshots/008-completed-zodiac-phone.png)
...
![The completed keepsake survives an app reload and remains shareable](./screenshots/009-restored-result-phone.png)
